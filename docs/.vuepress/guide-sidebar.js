  ...
  },
  {
    ...
    children: [
      { text: '3.1　关键字总索引', link: '/guide/03-keyword-index.html' },
      {
        ...
        collapsible: true,
        children: [
          { text: '3.2.1　标题信息', link: '/guide/03-co-pathway.html#co-3-2-1' },
          { text: '3.2.2　扩散选项', link: '/guide/03-co-dispersion.html#co-3-2-2' },
          { text: '3.2.3　低风速参数', link: '/guide/03-co-lowwind-downwash.html#co-3-2-3' },
          { text: '3.2.4　建筑物下洗选项', link: '/guide/03-co-lowwind-downwash.html#co-3-2-4' },
          { text: '3.2.5　NO₂ 转换输入参数', link: '/guide/03-co-no2.html#co-3-2-5' },
          { text: '3.2.6　平均时间选项', link: '/guide/03-co-averaging-urban.html#co-3-2-6' },
          { text: '3.2.7　MULTYEAR 多年分析', link: '/guide/03-co-averaging-urban.html#co-3-2-7' },
          { text: '3.2.8　城市模拟选项', link: '/guide/03-co-averaging-urban.html#co-3-2-8' },
          { text: '3.2.9　指定污染物类型', link: '/guide/03-co-averaging-urban.html#co-3-2-9' },
          { text: '3.2.10　指数衰减模拟', link: '/guide/03-co-averaging-urban.html#co-3-2-10' },
          { text: '3.2.11　旗杆式受体高度', link: '/guide/03-co-averaging-urban.html#co-3-2-11' },
          { text: '3.2.12　航空器烟羽抬升', link: '/guide/03-co-averaging-urban.html#co-3-2-12' },
          { text: '3.2.13　运行或仅检查输入', link: '/guide/03-co-run-debug.html#co-3-2-13' },
          { text: '3.2.14　生成 EVENT 输入文件', link: '/guide/03-co-run-debug.html#co-3-2-14' },
          { text: '3.2.15　模型重新启动', link: '/guide/03-co-run-debug.html#co-3-2-15' },
          { text: '3.2.16　颗粒物 NAAQS', link: '/guide/03-co-run-debug.html#co-3-2-16' },
          { text: '3.2.17　1小时 NO₂/SO₂ NAAQS', link: '/guide/03-co-run-debug.html#co-3-2-17' },
          { text: '3.2.18　调试输出选项', link: '/guide/03-co-run-debug.html#co-3-2-18' },
          { text: '3.2.19　详细错误消息文件', link: '/guide/03-co-run-debug.html#co-3-2-19' },
        ],
      },
      {
        text: '3.3　SO 污染源路径',
