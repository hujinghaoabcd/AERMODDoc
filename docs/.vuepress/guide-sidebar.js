  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        collapsible: true,
        children: [
          { text: '3.3.1　标识源类型和位置', link: '/guide/03-so-pathway.html#so-3-3-1' },
          { text: '3.3.2　指定污染源排放参数', link: '/guide/03-so-location.html#so-3-3-2' },
          { text: '3.3.3　气态污染物沉降参数', link: '/guide/03-so-emissions.html#so-3-3-3' },
          { text: '3.3.4　颗粒物沉降参数', link: '/guide/03-so-emissions.html#so-3-3-4' },
          { text: '3.3.5　排放与输出单位', link: '/guide/03-so-emissions.html#so-3-3-5' },
          { text: '3.3.6　NO₂ 转换的源输入参数', link: '/guide/03-so-deposition-no2.html#so-3-3-6' },
          { text: '3.3.7　PVMRM 与 PSD 增量抵扣', link: '/guide/03-so-deposition-no2.html#so-3-3-7' },
          { text: '3.3.8　背景浓度', link: '/guide/03-so-background-downwash.html#so-3-3-8' },
          { text: '3.3.9　建筑物下洗信息', link: '/guide/03-so-background-downwash.html#so-3-3-9' },
          { text: '3.3.10　城市源', link: '/guide/03-so-variable-emissions.html#so-3-3-10' },
          { text: '3.3.11　可变排放系数 EMISFACT', link: '/guide/03-so-variable-emissions.html#so-3-3-11' },
          { text: '3.3.12　逐小时排放文件 HOUREMIS', link: '/guide/03-so-variable-emissions.html#so-3-3-12' },
          { text: '3.3.13　排放速率与输出单位转换', link: '/guide/03-so-variable-emissions.html#so-3-3-13' },
          { text: '3.3.14　外部污染源文件', link: '/guide/03-so-groups-special.html#so-3-3-14' },
          { text: '3.3.15　污染源组', link: '/guide/03-so-groups-special.html#so-3-3-15' },
          { text: '3.3.16　海上平台下洗', link: '/guide/03-so-groups-special.html#so-3-3-16' },
          { text: '3.3.17　HBP 高浮力点源', link: '/guide/03-so-groups-special.html#so-3-3-17' },
          { text: '3.3.18　飞机源', link: '/guide/03-so-groups-special.html#so-3-3-18' },
        ],
      },
      {
        text: '3.4　RE 受体路径',
